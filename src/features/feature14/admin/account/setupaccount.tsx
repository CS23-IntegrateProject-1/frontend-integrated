...
import { Box, FormControl, FormLabel, Input, Textarea, Button, Radio, Stack, Image } from '@chakra-ui/react'
...
export const AccountSetupPage: React.FC = () => {
  ...
  const handleFormSubmit = async (event: React.FormEvent) => {
    ...
    try {
      ...
      formData.append('opening_hour', fromTime !== null && fromTime !== undefined ? fromTime.toISOString() : '')// Still don't have
      formData.append('closing_hour', toTime !== null && toTime !== undefined ? toTime.toISOString() : '')// Still don't have
          ...
          void handleFormSubmit(event)// Use the `void` operator to handle the Promise
            ...
            >
              <Image
                ...
                src={profilePhoto instanceof File ? URL.createObjectURL(profilePhoto) : profilePhoto ?? 'https://bit.ly/dan-abramov'}
                alt="Selected Photo"
              />
            </Box>
            ...
            {category === 'restaurant' && restaurantSubcategory != null && (
                <FormControl mt={4}>
