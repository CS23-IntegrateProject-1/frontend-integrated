...
const colors = {
    ...
    brand: {
        ...
        110: "#DEBEF6C0", // dark accent with opacity for business design
        200: "#A533C8", // dark second -> ex. color={"brand.200"}
        210: "#A533C890", // dark second with opacity for business design
        300: "#5F0DBB", // dark primary
        310: "#5F0DBB70", // dark primary with opacity for business design
